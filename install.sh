...
echo -e "  ${BOLD}${C}╚═════╝ ╚═════╝          ╚═╝   ╚═╝  ╚═╝╚═╝  ╚═╝ ╚═════╝╚═╝  ╚═╝╚══════╝╚═╝  ╚═╝${RESET}"
echo
echo -e "  ${DIM}Blackboard activity tracker  ·  by ${W}Franker26${RESET}  ${DIM}v1.0.31${RESET}"
echo -e "  ${DIM}──────────────────────────────────────────────${RESET}"
echo
...
# ── 5. Credenciales ───────────────────────────────────────────────────────────
echo -e "  ${BOLD}Configuración de Blackboard${RESET}"
echo -e "  ${DIM}──────────────────────────────────────────────${RESET}"
echo

printf "  ${C}URL${RESET} [https://palermo.blackboard.com]: "
read -r BB_URL
BB_URL="${BB_URL:-https://palermo.blackboard.com}"

while true; do
    printf "  ${C}Usuario${RESET}: "
    read -r BB_EMAIL
    [ -n "$BB_EMAIL" ] && break
    echo -e "  ${R}El usuario no puede estar vacío.${RESET}"
done

while true; do
    printf "  ${C}Contraseña${RESET}: "
    read -rs BB_PASSWORD
    echo
    [ -n "$BB_PASSWORD" ] && break
    echo -e "  ${R}La contraseña no puede estar vacía.${RESET}"
done
